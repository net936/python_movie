...
class Thing(models.Model):
    ...
    daoyan = models.CharField(max_length=50, blank=True, null=True)  # 导演
    shichang = models.CharField(max_length=50, blank=True, null=True)  # 时长
    location = models.CharField(max_length=50, blank=True, null=True)  # 地区
    yuyan = models.CharField(max_length=50, blank=True, null=True)  # 语言
    nianfen = models.CharField(max_length=50, blank=True, null=True)  # 年份
    shangying = models.CharField(max_length=50, blank=True, null=True)  # 上映时间
    fangying = models.CharField(max_length=50, blank=True, null=True)  # 放映
    fangyingting = models.CharField(max_length=50, blank=True, null=True)  # 放映厅
    renyuan = models.CharField(max_length=50, blank=True, null=True)  # 人员表
    repertory = models.IntegerField(default=0)  # 余票数
    status = models.CharField(max_length=1, choices=STATUS_CHOICES, default='0')
    create_time = models.DateTimeField(auto_now_add=True, null=True)
